...
/// @title BloiNFT - Tokenized Invoice as RWA
/// @notice ERC721 representing tokenized invoices with privacy-preserving commitments
/// @dev Invoice data is stored as commitments (hashes) for privacy - Part of bloi Protocol
contract InvoiceNFT is ERC721, ERC721Enumerable, Ownable {
    ...
    constructor() ERC721("Bloi Invoice", "BLOI") Ownable(msg.sender) {}
